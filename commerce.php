...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-laptop"></i> E-commerce</h3></header>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="dashboard.php">Dashboard</a></li>
                    <li><i class=""></i><a href="commerce.php">commerce</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    Student doing there project under E-commerce
                    </header>
